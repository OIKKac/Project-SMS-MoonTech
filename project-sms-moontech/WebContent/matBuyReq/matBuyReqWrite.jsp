...
<form role="form" method="post" action="mat.do?command=mat_buy_req_write">
   ...
   <input type="hidden" name="sendValue" id="sendValue"> <input
      ...
      type="hidden" name="inAmtValue" id="inAmtValue"> <input
      type="hidden" name="reqSq" value="${reqSq}"> <input
               ...
               <div class="row">
                  <div class="col-lg-5">
                     <div class="form-group focused">
                        <label class="form-control-label" for="input-username">재료구매요청서번호</label>
                        <input type="text" id="input-username"
                           class="form-control form-control-alternative"
                           value="${reqSq}" disabled>
                     </div>
                  </div>
                  <!-- <div class="col-lg-4">
            ...
            <div class="row">
               ...
               <div class="col-xl-13">
                  <div class="card shadow cj">
                     ...
                     <c:forEach items="${stockList}" var="mat">
                                 <tr>
