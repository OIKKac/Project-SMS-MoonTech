				...
				<div class="row">
								<div class="col-lg-6">
									<div class="form-group">
										...
										<input type="text" value = "${matSq}" class="form-control form-control-alternative" disabled />
									</div>
								</div>
								<div class="col-lg-6">
									<div class="form-group">
							...
							<div class="row">
								<div class="col-lg-6">
									<div class="form-group">
										...
										<input type="text"  name="matSize" class="form-control form-control-alternative"  />
									</div>
								</div>
								<div class="col-lg-6">
									<div class="form-group">
